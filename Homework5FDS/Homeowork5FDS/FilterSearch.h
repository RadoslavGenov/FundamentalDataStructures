...
void printResult(vector<SparePart*> results) {//print the result
	...
	{
		cout << i << setw(10)
			<< results.at(i)->getName() << setw(10)
			<< results.at(i)->getQuantity() << setw(10)
			<< results.at(i)->getPrice() << setw(10)
			<< results.at(i)->getStatus() << setw(10)
			<< results.at(i)->getLocation() << setw(10)
			<< results.at(i)->getProducer() << setw(10)
			<< results.at(i)->getModel() << setw(10)
